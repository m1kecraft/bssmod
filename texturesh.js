...
window.textures_bees=function(tex_ctx){
    ...
    tex_ctx.translate(128*15,256*2)
    tex_ctx.fillStyle='rgb(0, 0, 0)'
    tex_ctx.fillRect(0,0,128,128)
    tex_ctx.beginPath();
    tex_ctx.moveTo(34,30)
    tex_ctx.lineTo(54,30)
    tex_ctx.lineTo(44,40)
    tex_ctx.lineTo(34,30)
    tex_ctx.moveTo(74,30)
    tex_ctx.lineTo(94,30)
    tex_ctx.lineTo(84,40)
    tex_ctx.lineTo(74,30)
    tex_ctx.moveTo(44,70)
    tex_ctx.lineTo(64,90)
    tex_ctx.lineTo(84,70)
    tex_ctx.lineWidth=9
    tex_ctx.strokeStyle='#fff'
    tex_ctx.stroke()
    tex_ctx.fillStyle='rgb(27, 153, 20)'
    tex_ctx.fillRect(0,128,128,128/3)
    tex_ctx.fillStyle='rgb(29, 240, 17)'
    tex_ctx.fillRect(0,128+128/3,128,128/3)
    tex_ctx.fillStyle='rgb(27, 153, 20)'
    tex_ctx.fillRect(0,128+128*2/3,128,128/3)
    tex_ctx.setTransform(1,0,0,1,0,0)
    //@
    ...
    tex_ctx.translate(128*15,256*2+768)
    tex_ctx.fillStyle='rgb(23, 117, 0)'
    tex_ctx.fillRect(0,0,128,128)
    tex_ctx.beginPath();
    tex_ctx.moveTo(34,30)
    tex_ctx.lineTo(54,30)
    ...
    tex_ctx.lineTo(64,90)
    tex_ctx.lineTo(84,70)
    tex_ctx.lineWidth=14
    tex_ctx.strokeStyle='rgba(219, 255, 217, 0.5)'
    tex_ctx.stroke()
    tex_ctx.fillStyle='#f00'
    tex_ctx.fillRect(0,128,128,128/6)
    tex_ctx.fillStyle='#fa0'
    tex_ctx.fillRect(0,128+128/6,128,128/6)
    tex_ctx.fillStyle='#ff0'
    tex_ctx.fillRect(0,128+128*2/6,128,128/6)
    tex_ctx.fillStyle='#0f0'
    tex_ctx.fillRect(0,128+128*3/6,128,128/6)
    tex_ctx.fillStyle='#08f'
    tex_ctx.fillRect(0,128+128*4/6,128,128/6)
    tex_ctx.fillStyle='#c800ff'
    tex_ctx.fillRect(0,128+128*5/6,128,128/6)
    star('rgb(0,0,0)')
    tex_ctx.setTransform(1,0,0,1,0,0)
}
